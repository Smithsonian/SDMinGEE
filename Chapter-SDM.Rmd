...
![Figure S8. Example of two spatial blocks created for cross validation. In the two examples shown here, blocks of 500 x 500 km have been randomly splet in 70% for training data (blue) and 30% for validation data (red).](./Figures/Fig8.png)
